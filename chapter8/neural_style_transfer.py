# -*- coding: utf-8 -*-
"""
Created on Thu Nov  8 20:17:22 2018
...
# 変換したい画像へのパス
target_image_path = 'original_content/mypic.jpg'

# スタイル画像へのパス
style_reference_image_path = 'style/LaJoconde.jpg'
...
# このクラスは、損失関数の値と勾配の値を2つのメソッド呼び出しを通じて取得できるように
# fetch_loss_and_gradsをラッピングする。この2つのメソッド呼び出しは、ここで使用する
...
# 画像を平坦化: scipy.optimize.fmin_l_bfgs_bは1次元ベクトルしか処理しない
x = x.flatten()
for i in range(iterations):
    ...
    # 損失関数を計算する関数と勾配を計算する関数を2つ別々の引数として
    # 渡さなければならないことに注意
